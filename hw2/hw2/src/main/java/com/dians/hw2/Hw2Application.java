package com.dians.hw2;

import com.dians.hw2.filter.impl.ColumnSelectionFilter;
import com.dians.hw2.filter.impl.DuplicateRemovalFilter;
import com.dians.hw2.filter.impl.HistoricFilter;
import com.dians.hw2.filter.impl.TourismFilter;
import com.dians.hw2.pipe.Pipe;
...
public class Hw2Application {
	...
	public static void main(String[] args) throws FileNotFoundException, IOException {
		...
		ClassLoader loader = Hw2Application.class.getClassLoader();
